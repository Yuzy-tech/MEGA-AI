...
const defaultOwner = '254114909109';
...
//
global.botname = process.env.BOTNAME || 'Yuzytech';
global.pairingNumber = process.env.BOT_NUMBER || '25411490910o' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '' ;  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['2541149090109', '254114909109']
